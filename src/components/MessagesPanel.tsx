 ...
 * 
 * v4.0 - Simplified to "Your Groups" only (Phase 1: invite-only, no Discover)
 * 
 * Shows:
          ...
          {groupsWithChat.length === 0 ? (
            <div className="p-8 text-center">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
                Create a group or join one with an invite link to start chatting!
              </p>
            </div>
          ) : (
