...
const ChatTab: React.FC<ChatTabProps> = ({ eventId, onCreateEvent }) => {
  ...
  return (
    <div className="flex flex-col flex-1 min-h-0 bg-white/95 backdrop-blur rounded-t-xl rounded-b-none shadow-lg shadow-slate-200/50 border border-slate-200/80 border-b-0 overflow-hidden -mx-4 -mb-2">
