...
const App: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 flex flex-col bg-gradient-to-b from-slate-50 via-white to-slate-100 dark:from-slate-950 dark:via-slate-950 dark:to-slate-900 text-gray-900 dark:text-slate-100">
      ...
      {/* Bottom nav container - wraps footer + safe area filler for seamless iOS home indicator coverage */}
      <div className="flex-shrink-0 flex flex-col bg-white dark:bg-[#09243F] z-40">
        <nav className="bottom-nav border-t border-gray-200 dark:border-white/10 flex items-center justify-around px-2">
          <Link
            to="/"
        ...
        {/* Safe area filler - fills iOS home indicator region with nav's background color */}
        <div className="safe-area-bottom-fill" aria-hidden="true" />
      </div>
      <ToastManager />
