...
# Commit and push to the tracked branch (e.g., master). Amplify auto-builds and deploys.

# Optional: S3 manual deploy commands are documented in section 5.
```
